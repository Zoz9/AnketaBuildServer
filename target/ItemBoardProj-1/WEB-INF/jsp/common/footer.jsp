    ...
    <div class="container">
        <div class="row">
            <div class="col l6 s12">
                ...
                <p class="grey-text text-lighten-4">We are a team of course students working on this project: Yevheniia Vorobei, Pohorelaia Anna,Dana Muzyka, Bazeliuk Volodimir, Serhii Kovalenko(please, write your names here!!!!!!!!)</p>
            </div>
